...
Фоновая задача (`Clean`, тикер раз в 24 часа) удаляет ревью (и связанные с ними сообщения) старше 3 месяцев — история не хранится вечно.
...
| `@bot list` | Список ревьюеров с весами и заморозками |
